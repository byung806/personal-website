...
export const projects: Record<string, ProjectMetadata> = {
    runway: {
        ...
        title: 'Runway',
        subtitle: 'MOBILE APP',
        tagline: 'Bite-sized lessons that fit how we learn today.',
        coverImage: '/p/runway/title-ss.png',
        logo: '/p/runway/logo.png',
        year: '2024',
        ...
        links: [
            ...
            { label: 'App Store', url: 'https://apps.apple.com/us/app/runway-gamify-learning/id6639588047?itsct=apps_box_badge&itscg=30200' },
    ...
    'troopwebhost': {
        ...
        coverImage: '/p/troopwebhost/boy-scouts.png',
